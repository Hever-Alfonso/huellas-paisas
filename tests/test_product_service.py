...
class TestProductService:
    ...
    def test_create_product_con_precio_invalido_lanza_error(self, service):
        # El DTO debe rechazar esto antes incluso de llegar al service,
        # pero probamos el camino completo construyendo el DTO con
        # model_construct que salta la validación.
